...
<div class="register">
    ...
    <form action="" method="">
        ...
        <div class="item">
            ...
            <div class="container-input">
                <input type="password" class="input-custom" id="password" required>
            </div>
        </div>
        <div class="item">
            <div class="title-input">Xác nhận mật khẩu:</div>
            <div class="container-input">
                <input type="password" class="input-custom" id="repassword" required>
            </div>
        </div>
        <p>Sử dụng mật khẩu với ít nhất 8 ký tự bao gồm chữ in hoa, chữ thường và chữ số</p>
        <div class="button-wrap">
            <div class=" btn btn-return">
                <button type="button" onclick="test()">Trở về</button>
            </div>
            <div class=" btn btn-register">
                <button type="submit" name="submit" onsubmit="validateForm()">Đăng ký</button>
            </div>
        </div>
    </form>
</div>
